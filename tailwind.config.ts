  ...
  theme: {
    extend: {
      colors: {
        ...
        status_paid: 'hsl(var(--status-paid))',
        status_pending: 'hsl(var(--status-pending))',
        status_overdue: 'hsl(var(--status-overdue))',
        status_draft: 'hsl(var(--status-draft))',
        status_cancelled: 'hsl(var(--status-cancelled))',
      },
      borderRadius: {
        lg: `var(--radius)`,
