        ...
        <div className="space-y-8">
          ...
          <div className="bg-white/40 backdrop-blur-lg rounded-xl border border-white/20 shadow-lg p-6 dark:bg-gray-800/40 dark:border-gray-700">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-white/50 dark:bg-gray-700/50">
              ...
              <a href="/profile" className="btn-secondary bg-white/60 dark:bg-gray-600/60 dark:text-gray-200">Manage Profile</a>
            </div>
          </div>
          ...
          <div className="flex justify-end pt-4">
            <button onClick={handleSaveSettings} disabled={saving} className="btn-primary bg-blue-500 hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800">
