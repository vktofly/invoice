  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-8 pt-8 pb-2">
        <div>
          <h1 className="text-2xl font-semibold flex items-center gap-2">Hello, Vikash <span className="text-lg font-normal text-gray-400">👋</span></h1>
          <div className="text-gray-500 text-sm">emporg</div>
        </div>
      ...
      {/* Tab navigation for Dashboard, Announcements, Recent Updates */}
      <div className="flex gap-2 border-b bg-white px-8 pt-4">
        {TABS.map((t) => (
          <button
            key={t.value}
