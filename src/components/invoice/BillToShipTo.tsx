  ...
  return (
    <div className="w-full px-8 mb-10">
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        {/* Bill To */}
        <div className="flex-1 bg-gray-50 p-4 border border-gray-200 min-h-[80px] flex flex-col justify-start">
          ...
          {(() => {
                  ...
                  {!showAddAddress ? (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button type="button" className="bg-gray-200 px-3 py-1 rounded" onClick={() => setShowAddAddress(false)} disabled={saving}>
                          Cancel
                        </button>
                      </div>
            ...
            return (
              <>
                ...
                <div className="text-sm text-gray-700 mb-1">{customer.city || ''} {customer.state || ''} {customer.zip || ''}</div>
        ...
        {/* Ship To */}
        <div className="flex-1 bg-gray-50 p-4 border border-gray-200">
          <h3 className="font-semibold mb-2 flex items-center gap-2">Ship To
            <button
              type="button"
